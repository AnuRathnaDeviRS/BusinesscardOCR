...
st.set_page_config(page_title= "Business card",
                   ...
                   menu_items={'About':"This dashboard app is created by Anu Rathna Devi R S!"}
                   )
...
if selected=='Home':
    ...
    with col1:
        ...
        st.markdown(":violet[This Streamlit web application enables users to upload an image of a business card and utilize EasyOCR to extract relevant information from it. The extracted data can be viewed, edited, or deleted within the application. Users can also save the extracted information along with the business card image to a database. Each record in the database will contain the business card image and its corresponding extracted data, allowing for the storage of multiple entries.]")
    ...
    with col2:
        ...
        card_pic=Image.open(r"C:\Users\HP\Documents\intern\1.png")
